import { getSetBySessionId, getSetBySetId } from "../model/flashcardSet.model.js";
import { createSession, getSessionById, initalizeSessionCards, moveCardToLearned } from "../model/learnSession.model.js";
...
export async function refreshSession(req, res) {
    ...
    try {
        ...
        const updatedSession = await initalizeSessionCards(sessionId, originalSet.flashcards);
