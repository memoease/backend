...
router.post("/card/:setId", requireAuth, checkUserAccess, FlashcardSetController.postNewCard);
...
router.delete("/:setId", requireAuth, checkUserAccess, FlashcardSetController.deleteSetAndCards);
